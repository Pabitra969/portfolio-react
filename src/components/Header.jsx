...
const Header = () => {
  ...
  return (
        <div className="sticky top-0 bg-primary-50 flex justify-between items-center pt-10 pb-10 lg:pl-40 lg:pr-40 md:pl-20 md:pr-20 max-sm:pl-10 max-sm:pr-10 text-bluish" >
      ...
      <div
        className={clsx(
          "flex lg:gap-20 gap-10 text-[15px] transition-all duration-300",
              ToggleEvent ? "max-sm:flex flex-col items-center fixed inset-x-0 top-30 w-full h-screen bg-primary-50 p-5 rounded-2xl shadow-lg" : "max-sm:hidden"
        )}
      >
